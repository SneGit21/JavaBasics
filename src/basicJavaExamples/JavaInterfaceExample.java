...
public class JavaInterfaceExample implements IntExample{
  ...
  */
  ...
  public void sayHello(int a){
	    System.out.println("Hello Visitor !");
	    int b = 2;
	    System.out.println("Value without braces = "+a+b);
	    System.out.println("Value with braces = "+(a+b));
	  }
  ...
  public static void main(String args[]){
    ...
    javaInterfaceExample.sayHello(3);
    String s = javaInterfaceExample.sayHello("Marathe");
